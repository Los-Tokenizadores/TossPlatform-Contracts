...
{
    public partial class TossErc721MarketV1Service: ContractWeb3ServiceBase
    {
        ...
        public Task<string> Tosserc721marketv1InitRequestAsync(Tosserc721marketv1InitFunction tosserc721marketv1InitFunction)
        {
             return ContractHandler.SendRequestAsync(tosserc721marketv1InitFunction);
        }

        public Task<TransactionReceipt> Tosserc721marketv1InitRequestAndWaitForReceiptAsync(Tosserc721marketv1InitFunction tosserc721marketv1InitFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(tosserc721marketv1InitFunction, cancellationToken);
        }

        public Task<string> Tosserc721marketv1InitRequestAsync(string name, string symbol)
        {
        ...
        public Task<TransactionReceipt> Tosserc721marketv1InitRequestAndWaitForReceiptAsync(string name, string symbol, CancellationTokenSource cancellationToken = null)
        {
            var tosserc721marketv1InitFunction = new Tosserc721marketv1InitFunction();
                tosserc721marketv1InitFunction.Name = name;
                tosserc721marketv1InitFunction.Symbol = symbol;
        ...
        public Task<string> SafeMintRequestAsync(string to, BigInteger id)
        {
        ...
        public Task<TransactionReceipt> SafeMintRequestAndWaitForReceiptAsync(string to, BigInteger id, CancellationTokenSource cancellationToken = null)
        {
            var safeMintFunction = new SafeMintFunction();
                safeMintFunction.To = to;
                safeMintFunction.Id = id;
