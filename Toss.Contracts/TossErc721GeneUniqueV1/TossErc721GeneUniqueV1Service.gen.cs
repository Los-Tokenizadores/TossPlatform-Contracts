...
using Toss.Contracts.TossErc721GeneUniqueV1.ContractDefinition;

namespace Toss.Contracts.TossErc721GeneUniqueV1
{
    public partial class TossErc721GeneUniqueV1Service: TossErc721GeneUniqueV1ServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, TossErc721GeneUniqueV1Deployment tossErc721GeneUniqueV1Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<TossErc721GeneUniqueV1Deployment>().SendRequestAndWaitForReceiptAsync(tossErc721GeneUniqueV1Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, TossErc721GeneUniqueV1Deployment tossErc721GeneUniqueV1Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TossErc721GeneUniqueV1Deployment>().SendRequestAsync(tossErc721GeneUniqueV1Deployment);
        }

        public static async Task<TossErc721GeneUniqueV1Service> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, TossErc721GeneUniqueV1Deployment tossErc721GeneUniqueV1Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, tossErc721GeneUniqueV1Deployment, cancellationTokenSource);
            return new TossErc721GeneUniqueV1Service(web3, receipt.ContractAddress);
        }

        public TossErc721GeneUniqueV1Service(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class TossErc721GeneUniqueV1ServiceBase: ContractWeb3ServiceBase
    {

        public TossErc721GeneUniqueV1ServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
