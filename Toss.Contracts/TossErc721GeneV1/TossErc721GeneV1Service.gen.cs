...
{
    public partial class TossErc721GeneV1Service: TossErc721GeneV1ServiceBase
    {
        ...
        public TossErc721GeneV1Service(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class TossErc721GeneV1ServiceBase: ContractWeb3ServiceBase
    {

        public TossErc721GeneV1ServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
        ...
        public virtual Task<string> Tosserc721genev1InitRequestAsync(Tosserc721genev1InitFunction tosserc721genev1InitFunction)
        {
             return ContractHandler.SendRequestAsync(tosserc721genev1InitFunction);
        }

        public virtual Task<TransactionReceipt> Tosserc721genev1InitRequestAndWaitForReceiptAsync(Tosserc721genev1InitFunction tosserc721genev1InitFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(tosserc721genev1InitFunction, cancellationToken);
        }

        public virtual Task<string> Tosserc721genev1InitRequestAsync(string name, string symbol)
        {
        ...
        public virtual Task<TransactionReceipt> Tosserc721genev1InitRequestAndWaitForReceiptAsync(string name, string symbol, CancellationTokenSource cancellationToken = null)
        {
            var tosserc721genev1InitFunction = new Tosserc721genev1InitFunction();
                tosserc721genev1InitFunction.Name = name;
                tosserc721genev1InitFunction.Symbol = symbol;
        ...
        public override List<Type> GetAllFunctionTypes()
        {
            return new List<Type>
            {
                ...
                typeof(Tosserc721genev1InitFunction),
