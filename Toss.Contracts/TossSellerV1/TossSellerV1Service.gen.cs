...
{
    public partial class TossSellerV1Service: TossSellerV1ServiceBase
    {
    ...
    public partial class TossSellerV1ServiceBase: ContractWeb3ServiceBase
    {

        public TossSellerV1ServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
        ...
        public virtual Task<byte[]> ConvertRoleQueryAsync(BlockParameter blockParameter = null)
        {
        ...
        public virtual Task<byte> SellMaxLimitQueryAsync(BlockParameter blockParameter = null)
        {
        ...
        public virtual Task<string> Tosssellerv1InitRequestAsync(Tosssellerv1InitFunction tosssellerv1InitFunction)
        {
             return ContractHandler.SendRequestAsync(tosssellerv1InitFunction);
        }

        public virtual Task<TransactionReceipt> Tosssellerv1InitRequestAndWaitForReceiptAsync(Tosssellerv1InitFunction tosssellerv1InitFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(tosssellerv1InitFunction, cancellationToken);
        }

        public virtual Task<string> Tosssellerv1InitRequestAsync(string erc20)
        {
        ...
        public virtual Task<TransactionReceipt> Tosssellerv1InitRequestAndWaitForReceiptAsync(string erc20, CancellationTokenSource cancellationToken = null)
        {
            var tosssellerv1InitFunction = new Tosssellerv1InitFunction();
                tosssellerv1InitFunction.Erc20 = erc20;
        ...
        public virtual Task<string> BuyErc721RequestAsync(BuyErc721Function buyErc721Function)
        {
             return ContractHandler.SendRequestAsync(buyErc721Function);
        }

        public virtual Task<TransactionReceipt> BuyErc721RequestAndWaitForReceiptAsync(BuyErc721Function buyErc721Function, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(buyErc721Function, cancellationToken);
        }

        public virtual Task<string> BuyErc721RequestAsync(string erc721, byte amount)
        {
        ...
        public virtual Task<TransactionReceipt> BuyErc721RequestAndWaitForReceiptAsync(string erc721, byte amount, CancellationTokenSource cancellationToken = null)
        {
            var buyErc721Function = new BuyErc721Function();
                buyErc721Function.Erc721 = erc721;
                buyErc721Function.Amount = amount;
        ...
        public virtual Task<string> BuyErc721WithPermitRequestAsync(BuyErc721WithPermitFunction buyErc721WithPermitFunction)
        {
             return ContractHandler.SendRequestAsync(buyErc721WithPermitFunction);
        }

        public virtual Task<TransactionReceipt> BuyErc721WithPermitRequestAndWaitForReceiptAsync(BuyErc721WithPermitFunction buyErc721WithPermitFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(buyErc721WithPermitFunction, cancellationToken);
        }

        public virtual Task<string> BuyErc721WithPermitRequestAsync(string erc721, byte buyAmount, BigInteger amount, BigInteger deadline, byte v, byte[] r, byte[] s)
        {
        ...
        public virtual Task<TransactionReceipt> BuyErc721WithPermitRequestAndWaitForReceiptAsync(string erc721, byte buyAmount, BigInteger amount, BigInteger deadline, byte v, byte[] r, byte[] s, CancellationTokenSource cancellationToken = null)
        {
            var buyErc721WithPermitFunction = new BuyErc721WithPermitFunction();
                buyErc721WithPermitFunction.Erc721 = erc721;
                buyErc721WithPermitFunction.BuyAmount = buyAmount;
        ...
        public virtual Task<string> ConvertToErc20RequestAsync(ConvertToErc20Function convertToErc20Function)
        {
             return ContractHandler.SendRequestAsync(convertToErc20Function);
        }

        public virtual Task<TransactionReceipt> ConvertToErc20RequestAndWaitForReceiptAsync(ConvertToErc20Function convertToErc20Function, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(convertToErc20Function, cancellationToken);
        }

        public virtual Task<string> ConvertToErc20RequestAsync(string user, uint offchainAmount)
        {
        ...
        public virtual Task<TransactionReceipt> ConvertToErc20RequestAndWaitForReceiptAsync(string user, uint offchainAmount, CancellationTokenSource cancellationToken = null)
        {
            var convertToErc20Function = new ConvertToErc20Function();
                convertToErc20Function.User = user;
                convertToErc20Function.OffchainAmount = offchainAmount;
        ...
        public virtual Task<string> ConvertToOffchainRequestAsync(ConvertToOffchainFunction convertToOffchainFunction)
        {
             return ContractHandler.SendRequestAsync(convertToOffchainFunction);
        }

        public virtual Task<TransactionReceipt> ConvertToOffchainRequestAndWaitForReceiptAsync(ConvertToOffchainFunction convertToOffchainFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(convertToOffchainFunction, cancellationToken);
        }

        public virtual Task<string> ConvertToOffchainRequestAsync(BigInteger erc20Amount)
        {
        ...
        public virtual Task<TransactionReceipt> ConvertToOffchainRequestAndWaitForReceiptAsync(BigInteger erc20Amount, CancellationTokenSource cancellationToken = null)
        {
            var convertToOffchainFunction = new ConvertToOffchainFunction();
                convertToOffchainFunction.Erc20Amount = erc20Amount;
        ...
        public virtual Task<string> ConvertToOffchainWithPermitRequestAsync(ConvertToOffchainWithPermitFunction convertToOffchainWithPermitFunction)
        {
             return ContractHandler.SendRequestAsync(convertToOffchainWithPermitFunction);
        }

        public virtual Task<TransactionReceipt> ConvertToOffchainWithPermitRequestAndWaitForReceiptAsync(ConvertToOffchainWithPermitFunction convertToOffchainWithPermitFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(convertToOffchainWithPermitFunction, cancellationToken);
        }

        public virtual Task<string> ConvertToOffchainWithPermitRequestAsync(BigInteger erc20Amount, BigInteger amount, BigInteger deadline, byte v, byte[] r, byte[] s)
        {
        ...
        public virtual Task<TransactionReceipt> ConvertToOffchainWithPermitRequestAndWaitForReceiptAsync(BigInteger erc20Amount, BigInteger amount, BigInteger deadline, byte v, byte[] r, byte[] s, CancellationTokenSource cancellationToken = null)
        {
            var convertToOffchainWithPermitFunction = new ConvertToOffchainWithPermitFunction();
                convertToOffchainWithPermitFunction.Erc20Amount = erc20Amount;
                convertToOffchainWithPermitFunction.Amount = amount;
        ...
        public virtual Task<ushort> GetConvertToErc20CutQueryAsync(BlockParameter blockParameter = null)
        {
        ...
        public virtual Task<uint> GetConvertToErc20MinAmountQueryAsync(BlockParameter blockParameter = null)
        {
        ...
        public virtual Task<uint> GetConvertToErc20RateQueryAsync(BlockParameter blockParameter = null)
        {
        ...
        public virtual Task<ushort> GetConvertToOffchainCutQueryAsync(BlockParameter blockParameter = null)
        {
        ...
        public virtual Task<BigInteger> GetConvertToOffchainMinAmountQueryAsync(BlockParameter blockParameter = null)
        {
        ...
        public virtual Task<uint> GetConvertToOffchainRateQueryAsync(BlockParameter blockParameter = null)
        {
        ...
        public virtual Task<GetErc721SellsOutputDTO> GetErc721SellsQueryAsync(GetErc721SellsFunction getErc721SellsFunction, BlockParameter blockParameter = null)
        {
        ...
        public virtual Task<GetErc721SellsOutputDTO> GetErc721SellsQueryAsync(string erc721, BlockParameter blockParameter = null)
        {
        ...
        public virtual Task<string> SetConvertToErc20CutRequestAsync(SetConvertToErc20CutFunction setConvertToErc20CutFunction)
        {
             return ContractHandler.SendRequestAsync(setConvertToErc20CutFunction);
        }

        public virtual Task<TransactionReceipt> SetConvertToErc20CutRequestAndWaitForReceiptAsync(SetConvertToErc20CutFunction setConvertToErc20CutFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(setConvertToErc20CutFunction, cancellationToken);
        }

        public virtual Task<string> SetConvertToErc20CutRequestAsync(ushort newCut)
        {
        ...
        public virtual Task<TransactionReceipt> SetConvertToErc20CutRequestAndWaitForReceiptAsync(ushort newCut, CancellationTokenSource cancellationToken = null)
        {
            var setConvertToErc20CutFunction = new SetConvertToErc20CutFunction();
                setConvertToErc20CutFunction.NewCut = newCut;
        ...
        public virtual Task<string> SetConvertToErc20MinAmountRequestAsync(SetConvertToErc20MinAmountFunction setConvertToErc20MinAmountFunction)
        {
             return ContractHandler.SendRequestAsync(setConvertToErc20MinAmountFunction);
        }

        public virtual Task<TransactionReceipt> SetConvertToErc20MinAmountRequestAndWaitForReceiptAsync(SetConvertToErc20MinAmountFunction setConvertToErc20MinAmountFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(setConvertToErc20MinAmountFunction, cancellationToken);
        }

        public virtual Task<string> SetConvertToErc20MinAmountRequestAsync(uint minAmount)
        {
        ...
        public virtual Task<TransactionReceipt> SetConvertToErc20MinAmountRequestAndWaitForReceiptAsync(uint minAmount, CancellationTokenSource cancellationToken = null)
        {
            var setConvertToErc20MinAmountFunction = new SetConvertToErc20MinAmountFunction();
                setConvertToErc20MinAmountFunction.MinAmount = minAmount;
        ...
        public virtual Task<string> SetConvertToErc20RateRequestAsync(SetConvertToErc20RateFunction setConvertToErc20RateFunction)
        {
             return ContractHandler.SendRequestAsync(setConvertToErc20RateFunction);
        }

        public virtual Task<TransactionReceipt> SetConvertToErc20RateRequestAndWaitForReceiptAsync(SetConvertToErc20RateFunction setConvertToErc20RateFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(setConvertToErc20RateFunction, cancellationToken);
        }

        public virtual Task<string> SetConvertToErc20RateRequestAsync(uint newRate)
        {
        ...
        public virtual Task<TransactionReceipt> SetConvertToErc20RateRequestAndWaitForReceiptAsync(uint newRate, CancellationTokenSource cancellationToken = null)
        {
            var setConvertToErc20RateFunction = new SetConvertToErc20RateFunction();
                setConvertToErc20RateFunction.NewRate = newRate;
        ...
        public virtual Task<string> SetConvertToOffchainCutRequestAsync(SetConvertToOffchainCutFunction setConvertToOffchainCutFunction)
        {
             return ContractHandler.SendRequestAsync(setConvertToOffchainCutFunction);
        }

        public virtual Task<TransactionReceipt> SetConvertToOffchainCutRequestAndWaitForReceiptAsync(SetConvertToOffchainCutFunction setConvertToOffchainCutFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(setConvertToOffchainCutFunction, cancellationToken);
        }

        public virtual Task<string> SetConvertToOffchainCutRequestAsync(ushort newCut)
        {
        ...
        public virtual Task<TransactionReceipt> SetConvertToOffchainCutRequestAndWaitForReceiptAsync(ushort newCut, CancellationTokenSource cancellationToken = null)
        {
            var setConvertToOffchainCutFunction = new SetConvertToOffchainCutFunction();
                setConvertToOffchainCutFunction.NewCut = newCut;
        ...
        public virtual Task<string> SetConvertToOffchainMinAmountRequestAsync(SetConvertToOffchainMinAmountFunction setConvertToOffchainMinAmountFunction)
        {
             return ContractHandler.SendRequestAsync(setConvertToOffchainMinAmountFunction);
        }

        public virtual Task<TransactionReceipt> SetConvertToOffchainMinAmountRequestAndWaitForReceiptAsync(SetConvertToOffchainMinAmountFunction setConvertToOffchainMinAmountFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(setConvertToOffchainMinAmountFunction, cancellationToken);
        }

        public virtual Task<string> SetConvertToOffchainMinAmountRequestAsync(BigInteger minAmount)
        {
        ...
        public virtual Task<TransactionReceipt> SetConvertToOffchainMinAmountRequestAndWaitForReceiptAsync(BigInteger minAmount, CancellationTokenSource cancellationToken = null)
        {
            var setConvertToOffchainMinAmountFunction = new SetConvertToOffchainMinAmountFunction();
                setConvertToOffchainMinAmountFunction.MinAmount = minAmount;
        ...
        public virtual Task<string> SetConvertToOffchainRateRequestAsync(SetConvertToOffchainRateFunction setConvertToOffchainRateFunction)
        {
             return ContractHandler.SendRequestAsync(setConvertToOffchainRateFunction);
        }

        public virtual Task<TransactionReceipt> SetConvertToOffchainRateRequestAndWaitForReceiptAsync(SetConvertToOffchainRateFunction setConvertToOffchainRateFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(setConvertToOffchainRateFunction, cancellationToken);
        }

        public virtual Task<string> SetConvertToOffchainRateRequestAsync(uint newRate)
        {
        ...
        public virtual Task<TransactionReceipt> SetConvertToOffchainRateRequestAndWaitForReceiptAsync(uint newRate, CancellationTokenSource cancellationToken = null)
        {
            var setConvertToOffchainRateFunction = new SetConvertToOffchainRateFunction();
                setConvertToOffchainRateFunction.NewRate = newRate;
        ...
        public virtual Task<string> SetErc721SellRequestAsync(SetErc721SellFunction setErc721SellFunction)
        {
             return ContractHandler.SendRequestAsync(setErc721SellFunction);
        }

        public virtual Task<TransactionReceipt> SetErc721SellRequestAndWaitForReceiptAsync(SetErc721SellFunction setErc721SellFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(setErc721SellFunction, cancellationToken);
        }

        public virtual Task<string> SetErc721SellRequestAsync(string erc721, BigInteger price, byte maxAmount)
        {
        ...
        public virtual Task<TransactionReceipt> SetErc721SellRequestAndWaitForReceiptAsync(string erc721, BigInteger price, byte maxAmount, CancellationTokenSource cancellationToken = null)
        {
            var setErc721SellFunction = new SetErc721SellFunction();
                setErc721SellFunction.Erc721 = erc721;
                setErc721SellFunction.Price = price;
        ...
        public virtual Task<string> WithdrawBalanceRequestAsync(WithdrawBalanceFunction withdrawBalanceFunction)
        {
             return ContractHandler.SendRequestAsync(withdrawBalanceFunction);
        }

        public virtual Task<TransactionReceipt> WithdrawBalanceRequestAndWaitForReceiptAsync(WithdrawBalanceFunction withdrawBalanceFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(withdrawBalanceFunction, cancellationToken);
        }

        public virtual Task<string> WithdrawBalanceRequestAsync(BigInteger amount)
        {
        ...
        public virtual Task<TransactionReceipt> WithdrawBalanceRequestAndWaitForReceiptAsync(BigInteger amount, CancellationTokenSource cancellationToken = null)
        {
            var withdrawBalanceFunction = new WithdrawBalanceFunction();
                withdrawBalanceFunction.Amount = amount;
