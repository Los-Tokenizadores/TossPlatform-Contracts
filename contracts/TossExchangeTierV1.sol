...
contract TossExchangeTierV1 is TossExchangeBase {
    ...
    function __TossExchangeTierV1_init(address externalErc20Address_, uint256 externalMinAmount_, address internalErc20Address_, uint256 internalMinAmount_, uint64 rate_, uint64 year) initializer public {
        __TossExchangeBase_init(externalErc20Address_, externalMinAmount_, internalErc20Address_, internalMinAmount_, rate_);
